...
public class checkBooking implements Serializable{
	...
	public checkBooking(int booking_num, int room_num, int h_no, String booking_name, int booking_price,
			String start_day, String end_day, int userno, int stay_day, int p_condition, String b_date,
			String hotle_name) {
		super();
